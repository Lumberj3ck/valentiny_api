...
def test_upload_website_domain_not_exist(mock_crud_functions, mock_get_current_user, mocked_s3_client):
    mock_get_domain, mock_get_subdomain, mock_create_subdomain, mock_update_user_amounts = mock_crud_functions
    ...
    mock_create_subdomain.assert_not_called()
    mock_update_user_amounts.assert_not_called()
    mocked_s3_client.put_object.assert_not_called()

def test_upload_website_no_uploads_left(mock_crud_functions, mocked_s3_client):
    mock_get_domain, mock_get_subdomain, mock_create_subdomain, mock_update_user_amounts = mock_crud_functions
...
def test_upload_website_no_subdomains_left(mock_crud_functions, mocked_s3_client):
    mock_get_domain, mock_get_subdomain, mock_create_subdomain, mock_update_user_amounts = mock_crud_functions
    mock_get_subdomain.return_value = None
...
def test_upload_website_subdomain_not_available(mock_crud_functions, mock_get_current_user, mocked_s3_client):
    mock_get_domain, mock_get_subdomain, mock_create_subdomain, mock_update_user_amounts = mock_crud_functions
    mock_get_domain.return_value = True
